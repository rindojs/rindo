...
if (!win.__rindo_cssshim && needsShim()) {
    win.__rindo_cssshim = new CustomStyle(win, document);
}

var doc = document;
var scriptElm = doc.querySelector('script[data-rindo-namespace="app"]');
if (!scriptElm) {
...
if (win.__rindo_cssshim) {
  win.__rindo_cssshim.initShim().then(start);
} else {
  start();
}

module.exports = {
  moduleNameMapper: {
    ...
    '^@rindo/core/internal/app-data$': '<rootDir>/internal/app-data/index.cjs',
    '^@rindo/core/internal/testing$': '<rootDir>/internal/testing/index.js',
  },
  ...
  // TODO(RINDO-307): Move away from Jasmine runner for internal Rindo tests as a part of the (internal) Jest 28+ upgrade

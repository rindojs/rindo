...
export async function start(rindoDevServerConfig: RindoDevServerConfig, logger: Logger, watcher?: CompilerWatcher) {
  let devServer: DevServer = null;
  const devServerConfig = { ...rindoDevServerConfig } as DevServerConfig;

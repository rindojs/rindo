...
/**
 * Perform Hot Module Replacement for a given Rindo component (identified
 ...
 * @param hmrTagNames an out param containing a list of updated Rindo
 * component tag names
...
/**
 * Perform Hot Module Replacement (HMR) for a particular Rindo component

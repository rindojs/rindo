import type { EventInitDict, SerializedEvent } from '@rindo/core/internal';
 ...
 *
 * This function expects that the {@link E2EProcessEnv#__RINDO_PUPPETEER_VERSION__} be set prior to invocation. If
...
function getPuppeteerExecution(elmHandle: puppeteer.ElementHandle) {
  const puppeteerMajorVersion = parseInt(process.env.__RINDO_PUPPETEER_VERSION__, 10);

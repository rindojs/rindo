/*!
 * This file acts as the connector/bridge between Rindo and Jest.
 *
 * It defines/caches a `JestFacade` implementation to dispatch Jest-related configuration calls to the correct section
 * of the Rindo codebase.
 *
 * It contains the APIs that are designed to be used by the Jest pre-configurations supplied by Rindo.
 */

import semverMajor from 'semver/functions/major';

import { Jest27Rindo } from './jest-27-and-under/jest-facade';
 ...
 */
let JEST_RINDO_FACADE: JestFacade | null = null;
...
/**
 * Retrieve the default Jest runner name prescribed by Rindo
 *
 * @returns the stringified name of the test runner, based on the currently detected version of Rindo
 */
...
/**
 * Retrieve the Rindo-Jest test runner based on the version of Jest that's installed.
 *
 * @returns a test runner for Rindo tests, based on the version of Jest that's detected
 */
...
/**
 * Retrieve the Rindo-Jest screenshot facade implementation based on the version of Jest that's installed.
 *
 * @returns a screenshot facade implementation for Rindo tests, based on the version of Jest that's detected
 */
...
/**
 * Retrieve Rindo's Jest presets for the detected version of Jest
 *

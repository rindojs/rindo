import type { TranspileOptions, Diagnostic } from '@rindo/core/internal';
...
export const jestPreprocessor = {
  ...
  process(
    ...
    // TODO: Drop support for versions of Jest <27
    /**
     ...
     * removed in a future major version of Rindo.
     */
  ...
  getCacheKey(
     ...
     * functionality will be removed in a future major version of Rindo.
     */

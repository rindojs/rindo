...
/**
 * Interface for Jest-version specific code implementations that interact with Rindo.
 *
 * It is expected that there exists a Jest version-specific implementation for this interface in each version-specific
 * directory Rindo supports.
 */
export interface JestFacade {
  /**
   * Retrieve a function that invokes the Jest CLI.
   *
   * This function does not perform the invocation itself. Rather, it expects the caller to prepare a Rindo
  ...
  /**
   * Retrieve a function that invokes Rindo's Screenshot runner.
   *
   * This function does not start screenshot tests themselves. Rather, it expects the caller to prepare a Rindo
  ...
  /**
   * Retrieve a function that returns the custom Rindo-Jest test runner
   *

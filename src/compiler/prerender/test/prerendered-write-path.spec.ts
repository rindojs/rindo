...
describe('prerender-utils', () => {
  ...
  describe('getWriteFilePathFromUrlPath', () => {
    ...
    it('/subdir, custom indexHtml', () => {
      const inputUrl = 'http://rindojs.web.app/subdir';
      manager.outputTarget.baseUrl = 'http://rindojs.web.app/';
    ...
    it('/docs/my-index.htm, custom indexHtml', () => {
      const inputUrl = 'http://rindojs.web.app/docs/my-index.htm';
      manager.outputTarget.baseUrl = 'http://rindojs.web.app/docs/';
      manager.outputTarget.indexHtml = 'my-index.htm';
      const filePath = getWriteFilePathFromUrlPath(manager, inputUrl);
    ...
    it('/docs/index.html', () => {
      const inputUrl = 'http://rindojs.web.app/docs/index.html';
      manager.outputTarget.baseUrl = 'http://rindojs.web.app/docs/';
      const filePath = getWriteFilePathFromUrlPath(manager, inputUrl);
    ...
    it('/docs/', () => {
      const inputUrl = 'http://rindojs.web.app/docs/';
      manager.outputTarget.baseUrl = 'http://rindojs.web.app/docs/';
      const filePath = getWriteFilePathFromUrlPath(manager, inputUrl);
      expect(filePath).toBe(join(rootDir, 'www', 'index.html'));
    });
    ...
    it('custom indexHtml', () => {
      const inputUrl = 'http://rindojs.web.app/';
      manager.outputTarget.baseUrl = 'http://rindojs.web.app/';
      manager.outputTarget.indexHtml = 'my-index.htm';
      const filePath = getWriteFilePathFromUrlPath(manager, inputUrl);
      expect(filePath).toBe(join(rootDir, '/www/my-index.htm'));
    ...
    it('/index.html', () => {
      const inputUrl = 'http://rindojs.web.app/index.html';
      manager.outputTarget.baseUrl = 'http://rindojs.web.app/';
      const filePath = getWriteFilePathFromUrlPath(manager, inputUrl);
      expect(filePath).toBe(join(rootDir, 'www', 'index.html'));
    });

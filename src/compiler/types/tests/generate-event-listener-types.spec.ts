...
import * as RindoTypes from '../rindo-types';
...
describe('generate-event-listener-types', () => {
  describe('generateEventListenerTypes', () => {
    let updateTypeIdentifierNamesSpy: jest.SpyInstance<
      ReturnType<typeof RindoTypes.updateTypeIdentifierNames>,
      Parameters<typeof RindoTypes.updateTypeIdentifierNames>
    >;

    beforeEach(() => {
      updateTypeIdentifierNamesSpy = jest.spyOn(RindoTypes, 'updateTypeIdentifierNames');

 ...
 * @param config The Rindo config for the project
 ...
 * of the type that is used in a file, and an alias that Rindo may have generated for the name to avoid collisions.

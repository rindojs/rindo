import familyConfig from '@familyjs/prettier-config';
import { format } from 'prettier';

/**
 * Use the family-wide configuration to format some code and return the result.
 ...
 */
export const formatCode = (code: string): Promise<string> => format(code, { ...familyConfig, parser: 'typescript' });

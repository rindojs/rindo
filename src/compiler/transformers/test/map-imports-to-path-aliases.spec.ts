import type { OutputTargetDistCollection } from '@rindo/core/declarations';
...
describe('mapImportsToPathAliases', () => {
  ...
  it('ignores external imports', () => {
    ...
    expect(module.outputText).toContain('import { utils } from "@rindo/core";');
  });
  ...
  // TODO(RINDO-223): remove spy to test actual resolution behavior

import { mockCompilerCtx } from '@rindo/core/testing';
...
describe('lazy-component', () => {
  ...
  it('adds a getter for an @Element() reference', () => {
    ...
    expect(t.outputText).toContain(`get el() { return __rindo_getElement(this); } };`);
  ...
  it('adds an `attachInternals` call with a `@AttachInternals` decoration', async () => {
    ...
    expect(await formatCode(t.outputText)).toBe(
      await c`import { registerInstance as __rindo_registerInstance } from "@rindo/core";
      export const CmpA = class {
        constructor (hostRef) {
          __rindo_registerInstance(this, hostRef);
  ...
  describe('styling', () => {
    ...
    it(
      ...
      `,
        `
        import { registerInstance as __rindo_registerInstance } from "@rindo/core";

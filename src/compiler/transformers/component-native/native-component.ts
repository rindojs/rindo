...
/**
 * Update a {@link ts.ClassDeclaration} which corresponds to a Rindo
 ...
 * that are Rindo-specific implementation details.
 *
 * @param transformOpts options governing how Rindo components should be
 * transformed
 * @param classNode the class to transform
 * @param moduleFile information about the class' home module
 * @param cmp metadata about the rindo component of interest
 ...
 * Rindo component to extend `HTMLElement`
 *
...
/**
 * Perform various modifications to the class members of a Rindo component

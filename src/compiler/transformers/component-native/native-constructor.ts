...
/**
 * Generates a series of expression statements used to help initialize a Rindo component
 * @param moduleFile the Rindo module that will be instantiated
 ...
 * @param moduleFile the Rindo module that will use the generated expression statement
 * @returns the generated expression statement
 */

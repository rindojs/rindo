...
/**
 * Return a transformer factory which transforms a Rindo component to make it
 ...
 * designed to be run on a Rindo component which has already undergone
 * initial transformation (which handles things like converting decorators to
 * static and so on).
 *
 * @param compilerCtx a Rindo compiler context object

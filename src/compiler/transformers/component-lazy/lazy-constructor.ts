...
/**
 * Update the constructor for a Rindo component's class in order to prepare
 ...
 * `registerInstance` method from the Rindo core component runtime API.
 *
 * @param moduleFile information about a module containing a Rindo component

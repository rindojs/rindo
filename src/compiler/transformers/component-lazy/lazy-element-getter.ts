...
/**
 * If a Rindo component was declared with an `@Element` ref, transform the
 * class to support this getter.
 *
 * @param classMembers an out param which holds class members for the component
 * @param moduleFile information about the rindo component's home module
 * @param cmp metadata gathered about the Rindo component during compilation
 */
export const addLazyElementGetter = (
  ...
  // @Element() element;
  // is transformed into:
  // get element() { return __rindo_getElement(this); }
  if (cmp.elementRef) {

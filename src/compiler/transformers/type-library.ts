...
/**
 * Get the unique ID for a type which was referenced somewhere within a Rindo project.
 *
 ...
 * Rindo project, so we can track the locations from which a given type is
 * referenced.
 *

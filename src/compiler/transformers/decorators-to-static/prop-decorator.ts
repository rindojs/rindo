...
/**
 * Derives a Rindo-permitted prop type from the TypeScript compiler's output. This function may narrow the type of a
 * prop, as the types that can be returned from the TypeScript compiler may be more complex than what Rindo can/should
 * handle for props.
 * @param type the prop type to narrow
 * @returns a valid Rindo prop type
 */

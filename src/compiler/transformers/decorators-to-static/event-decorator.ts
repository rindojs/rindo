...
/**
 * Parse a single instance of Rindo's `@Event()` decorator and generate metadata for the class member that is
 * decorated
 ...
 * @param prop the property on the Rindo component class that is decorated with `@Event()`
...
/**
 * Derive Rindo's class member type metadata from a node in the AST

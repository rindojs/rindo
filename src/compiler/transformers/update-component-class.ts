...
/**
 * Transformation helper for updating how a Rindo component class is declared.
 *
 ...
 * @param classNode the node in the AST pertaining to the Rindo component class to transform
 ...
 * @param moduleFile the Rindo intermediate representation associated with the provided class node

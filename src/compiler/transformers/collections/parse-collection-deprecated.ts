...
function excludeFromCollection(config: d.Config, cmpData: d.ComponentDataDeprecated) {
  ...
  // for example, "navicons" is a dependency of "navify"
  // and "navify" is it's own stand-alone collection, so within
  // navify's collection we want navicons to just work

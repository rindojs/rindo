...
import { createRindoImportPath } from '../transformers/rindo-import-path';
...
export const transformCssToEsm = (config: d.Config, cssText: string, filePath: string, tagName: string, encapsulation: string, modeName: string) => {
  ...
  cssImports.forEach(cssImport => {
    ...
    const importPath = createRindoImportPath('css', tagName, encapsulation, modeName, cssImport.filePath);

      ...
      plugins: [
        {
          ...
          resolveId(id) {
            if (id === '@rindo/core/hydrate-factory') {
              return id;
            }
...
async function generateHydrateAppCore(config: d.Config, compilerCtx: d.CompilerCtx, buildCtx: d.BuildCtx) {
  ...
  coreText.push(`import { hydrateApp, registerComponents, styles } from '@rindo/core/platform';`);
  coreText.push(`import globals from '@rindo/core/global-scripts';`);

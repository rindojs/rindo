...
export const patchedTsResolveModule = (
  ...
  if (isLocalModule(moduleName)) {
    ...
    //
    // https://github.com/familyjs/rindo/blob/v3.0.0/src/compiler/sys/typescript/typescript-sys.ts#L165-L175
    //
    // but if you look at its call sites there are a few where we pass `null`
    // instead, eg:
    //
    // https://github.com/familyjs/rindo/blob/v3.0.0/src/compiler/transpile.ts#L42-L44
    //

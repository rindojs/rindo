...
`;
  ...
  <ul>
    ...
    <li>Note that as of Rindo v2, ES5 builds and polyfills are <strong>disabled</strong> during production builds. You can enable these <a href="https://rindojs.web.app/docs/config#buildes5" target="_blank" rel="noopener noreferrer">in your rindo.config.ts file</a>.</li>

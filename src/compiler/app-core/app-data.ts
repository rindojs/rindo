...
/**
 * Update the provided build conditionals object in-line with a provided Rindo project configuration
 *
 * **This function mutates the build conditionals argument**
 *
 * @param config the Rindo configuration to use to update the provided build conditionals

import { mockCompilerSystem, mockLoadConfigInit } from '@rindo/core/testing';
import ts from 'typescript';

import type * as d from '../../../declarations';
import { loadConfig } from '../load-config';

describe('rindo config - sourceMap option', () => {
  const configPath = require.resolve('./fixtures/rindo.config.ts');
   ...
   *
   * @param sourceMap The `sourceMap` option from the Rindo config.
   */

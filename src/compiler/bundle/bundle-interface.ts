...
export interface BundleOptions {
  ...
  /**
   * When `true`, all `@rindo/core/*` packages will be treated as external
  ...
  /**
   * A map of strings which are passed to the Rindo-specific loader plugin
   * which we use to resolve the imports of Rindo project files when building
   * with Rollup.
   *

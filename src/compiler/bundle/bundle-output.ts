...
/**
 * Build the rollup options that will be used to transpile, minify, and otherwise transform a Rindo project
...
export const getRollupOptions = (
  ...
  nodeResolvePlugin.resolve = async function () {
    // Investigate if we can use this to leverage Rindo's in-memory fs
  };

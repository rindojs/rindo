...
/**
 * Entrypoint for generating types for one or more `dist-custom-elements` output targets defined in a Rindo project's
 * configuration
...
/**
 * Generate a type declaration file for a specific Rindo component

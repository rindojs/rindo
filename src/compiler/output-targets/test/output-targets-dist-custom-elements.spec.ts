...
describe('Custom Elements output target', () => {
  ...
  describe('generateEntryPoint', () => {
    it('should include global scripts when flag is `true`', () => {
      ...
      expect(entryPoint).toEqual(`import { globalScripts } from '${RINDO_APP_GLOBALS_ID}';
...
`);
    ...
    it('should not include global scripts when flag is `false`', () => {
      ...
      expect(entryPoint)
        .toEqual(`export { getAssetPath, setAssetPath, setNonce, setPlatformOptions } from '${RINDO_INTERNAL_CLIENT_ID}';
export * from '${USER_INDEX_ENTRY_ID}';
`);
    });
  });

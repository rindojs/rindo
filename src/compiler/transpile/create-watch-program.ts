 ...
 * rebuilding a Rindo project after file changes have been detected (via TS's polling-based file watcher).
 *
...
export const createTsWatchProgram = async (
  ...
  const tsWatchSys: ts.System = {
     ...
     * the build processes. Rindo currently has an issue where multiple file changes are detected
  ...
  // This is what will be used to kick-off the actual Rindo build process via the `buildCallback()`

...
const BROWSER_ENTRY = `
import { bootstrapLazy, patchBrowser, globals } from '@rindo/core';
patchBrowser().then(options => {
  globals();
  return bootstrapLazy([/*!__RINDO_LAZY_DATA__*/], options);
});
`;

// This is for webpack
const EXTERNAL_ENTRY = `
import { bootstrapLazy, patchEsm, globals } from '@rindo/core';

export const defineCustomElements = (win, options) => {
  return patchEsm().then(() => {
    globals();
    bootstrapLazy([/*!__RINDO_LAZY_DATA__*/], options);
  });
};
`;

...
/**
 * Scan the provided `doc` for any known Rindo components
 * @param doc the Document to scan
 * @param cmps the compiler metadata of known Rindo components
 * @returns a list of all tags that were identified as known Rindo components
 */

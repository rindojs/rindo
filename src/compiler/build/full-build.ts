...
/**
 * Build a callable function to perform a full build of a Rindo project
 * @param config a Rindo configuration to apply to a full build of a Rindo project
 * @param compilerCtx the current Rindo compiler context
 * @returns the results of a full build of Rindo
 */
export const createFullBuild = async (
  ...
  return new Promise<d.CompilerBuildResults>((resolve) => {
    ...
    /**
     * A function that kicks off the transpilation process for both the TypeScript and Rindo compilers

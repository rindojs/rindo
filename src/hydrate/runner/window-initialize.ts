import { constrainTimeouts, type MockWindow } from '@rindo/core/mock-doc';
import { RINDO_DOC_DATA } from 'src/runtime/runtime-constants';
...
export function initializeWindow(
  ...
  (doc as d.RindoDocument)[RINDO_DOC_DATA] = docData;

 ...
 * Rindo project. During compilation, Rindo gathers information about the
...
export interface JsonDocs {
  /**
   * The metadata for the JSDocs for each component in a Rindo project
   */
  ...
  compiler: {
    ...
    name: string;
    /**
     * The version of the Rindo compiler that generated the metadata
     */
    version: string;
    /**
...
/**
 * Container for JSDoc metadata for a single Rindo component
 */
export interface JsonDocsComponent {
  /**
   * The directory containing the Rindo component, minus the file name.
   *
   * @example /workspaces/rindo-project/src/components/my-component
   */
  dirPath?: string;
  /**
   * The name of the file containing the Rindo component, with no path
   *
   * @example my-component.tsx
   */
  fileName?: string;
  /**
   * The full path of the file containing the Rindo component
   *
   * @example /workspaces/rindo-project/src/components/my-component/my-component.tsx
   */
  filePath?: string;
  /**
   * The path to the component's `readme.md` file, including the filename
   *
   * @example /workspaces/rindo-project/src/components/my-component/readme.md
   */
  readmePath?: string;
  /**
   * The path to the component's `usage` directory
   *
   * @example /workspaces/rindo-project/src/components/my-component/usage/
   */
  usagesDir?: string;
  /**
  ...
  readme: string;
  /**
   * The description of a Rindo component, found in the JSDoc that sits above the component's declaration
   */
  docs: string;
  /**

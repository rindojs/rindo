...
export interface RindoConfig {
   ...
   * as `isPrimaryPackageOutputTarget: true` in their Rindo config.
   */
...
interface ConfigExtrasBase {
   ...
   * @deprecated This option has been deprecated and will be removed in a future major version of Rindo.
   */
 ...
 * certain output targets for Rindo (in particular `dist`,
...
export interface CopyTask {
   ...
   * will default to `false`, so that Rindo will write the
...
export interface BundlingConfig {
   ...
   * This field can be safely removed from your Rindo configuration file.
   */
  namedExports?: {
    [key: string]: string[];
  };
...
export interface NodeResolveConfig {
   ...
   * describe your use case & provide input (https://github.com/rindojs/rindo/issues/new/choose)
   */
 ...
 *
 * A Node.js-specific implementation of this interface is used when Rindo is
 ...
 * (module, types, etc.). This allows them to be marked for validation in a project's Rindo config.
 */

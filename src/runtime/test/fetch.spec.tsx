...
import { mockFetch, MockHeaders, MockResponse, newSpecPage } from '@rindo/core/testing';
...
describe('fetch', () => {
  ...
  it('global Request/Response/Headers should work', () => {
    ...
    const request = new Request('http://rindojs-testing.web.app/some-url', {
      headers,
    });
    expect(request.url).toBe('http://rindojs-testing.web.app/some-url');

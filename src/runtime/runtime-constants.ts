...
/**
 * A (subset) of node types which are relevant for the Rindo runtime. These
...
export const RINDO_DOC_DATA = '_rindoDocData';
 ...
 *
 * Two cascading rules must be used instead of a `:not()` selector due to Rindo browser
 * support as of Rindo v4.
 */

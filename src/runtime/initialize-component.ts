...
/**
 * Initialize a Rindo component given a reference to its host element, its
 * runtime bookkeeping data structure, runtime metadata about the component,
 * and (optionally) an HMR version ID.
 *
 * @param elm a host element
 * @param hostRef the element's runtime bookkeeping object
 * @param cmpMeta runtime metadata for the Rindo component
...
export const initializeComponent = async (
  ...
  if ((hostRef.$flags$ & HOST_FLAGS.hasInitializedComponent) === 0) {
    ...
    if (BUILD.lazyLoad && bundleId) {
       ...
       * ```html
       * <script type="module">
       *   import { MyComponent } from 'my-rindo-component-library';

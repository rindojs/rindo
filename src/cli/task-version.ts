...
export async function validateCompilerVersion(sys: d.RindoSystem, logger: d.Logger, latestVersionPromise: Promise<string>) {
...
const NPM_INSTALL = `npm install @rindo/core`;
const ARROW = `→`;
const BOX_TOP_LEFT = `╭`;
const BOX_TOP_RIGHT = `╮`;

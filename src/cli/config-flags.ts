import type { LogLevel, TaskCommand } from '@rindo/core/declarations';
...
export const BOOLEAN_STRING_CLI_FLAGS = [
   ...
   * option to support Chrome's new headless mode. In order to support this option in Rindo, both the boolean and

import * as coreCompiler from '@rindo/core/compiler';
...
describe('prepareData', () => {
  ...
  beforeEach(() => {
    ...
    sys.name = 'in-memory';
    sys.version = '__VERSION:RINDO__';
  });

  it('prepares an object to send to family', async () => {
    ...
    expect(data).toEqual({
      ...
      rindo: coreCompiler.versions.rindo,
      system: 'in-memory __VERSION:RINDO__',
      system_major: 'in-memory __VERSION:RINDO__',
      targets: [],
      task: null,

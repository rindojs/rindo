...
function* streamToHtml(
  ...
  if (node.nodeType === NODE_TYPES.ELEMENT_NODE || isShadowRoot) {
    ...
    if (ignoreTag === false) {
      ...
      /**
       * ToDo: the shadow root class is `#document-fragment`
        ...
        if (childNodeLength > 0) {
          if (
            ...
            for (let i = 0; i < childNodeLength; i++) {
               ...
               * Rindo component, we want to skip over the template tag as we
               * will be parsing the shadow root of the component again.
               *
               * We know it is a hydrated Rindo component by checking if the `HYDRATE_ID`
               * is set on the node.
               */
...
// TODO(RINDO-1299): Audit this list, remove unsupported/deprecated elements
...
// TODO(RINDO-1299): Audit this list, remove unsupported/deprecated attr
...
/**
 * Partially duplicate of https://github.com/rindojs/rindo/blob/1e6d201489aecaff10254438cde805a05e9509de/src/declarations/rindo-public-compiler.ts#L895

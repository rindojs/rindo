...
describe('MockRequest', () => {
  it('no input defaults', () => {
    ...
    expect(request.url).toBe('http://rindojs-testing.web.app/');
  });
  ...
  it('string url', () => {
    ...
    expect(request.referrer).toBe('about:client');
    expect(request.referrerPolicy).toBe('');
    expect(request.url).toBe('http://rindojs-testing.web.app/my-url');
  });
  ...
  it('request input', () => {
    ...
    expect(request.referrer).toBe('about:client');
    expect(request.referrerPolicy).toBe('');
    expect(request.url).toBe('http://rindojs-testing.web.app/request-url');

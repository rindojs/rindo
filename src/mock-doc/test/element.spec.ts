...
describe('element', () => {
  ...
  describe('document', () => {
    ...
    it('document.baseURI', () => {
      ...
      `);
      win.location.href = 'http://rindojs.web.app/path/to/page';
      expect(win.document.baseURI).toBe('http://rindojs.web.app/en');
      expect(win.document.URL).toBe('http://rindojs.web.app/path/to/page');
      expect(win.document.location.href).toBe('http://rindojs.web.app/path/to/page');

      // use the bang operator here to fail in case 'base' can't be found
      win.document.querySelector('base')!.remove();
      expect(win.document.baseURI).toBe('http://rindojs.web.app/path/to/page');
      expect(win.document.URL).toBe('http://rindojs.web.app/path/to/page');
      expect(win.document.location.href).toBe('http://rindojs.web.app/path/to/page');
    });
  });
  ...
  describe('link', () => {
    it('href', () => {
      ...
      elm.href = 'http://rindojs.web.app/path/to/page';
      expect(elm.href).toBe('http://rindojs.web.app/path/to/page');
    });

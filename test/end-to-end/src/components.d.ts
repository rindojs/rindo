...
export namespace Components {
    ...
    interface CmpDsd {
        ...
        /**
         * @deprecated use camelCase instead. Support for dash-casing will be removed in Rindo v5.
         */
...
declare global {
    interface HTMLAnotherCarDetailElement extends Components.AnotherCarDetail, HTMLRindoElement {
    }
     ...
     * Component that helps display a list of cars
     */
    interface HTMLAnotherCarListElement extends Components.AnotherCarList, HTMLRindoElement {
    ...
    interface HTMLCarDetailElement extends Components.CarDetail, HTMLRindoElement {
    }
     ...
     * Component that helps display a list of cars
     */
    interface HTMLCarListElement extends Components.CarList, HTMLRindoElement {
    ...
    interface HTMLCmpDsdElement extends Components.CmpDsd, HTMLRindoElement {
    }
    var HTMLCmpDsdElement: {
        prototype: HTMLCmpDsdElement;
        new (): HTMLCmpDsdElement;
    };
    interface HTMLCmpServerVsClientElement extends Components.CmpServerVsClient, HTMLRindoElement {
    }
    var HTMLCmpServerVsClientElement: {
        prototype: HTMLCmpServerVsClientElement;
        new (): HTMLCmpServerVsClientElement;
    };
    interface HTMLCmpWithSlotElement extends Components.CmpWithSlot, HTMLRindoElement {
    }
    var HTMLCmpWithSlotElement: {
        prototype: HTMLCmpWithSlotElement;
        new (): HTMLCmpWithSlotElement;
    };
    interface HTMLDomApiElement extends Components.DomApi, HTMLRindoElement {
    }
    var HTMLDomApiElement: {
        prototype: HTMLDomApiElement;
        new (): HTMLDomApiElement;
    };
    interface HTMLDomInteractionElement extends Components.DomInteraction, HTMLRindoElement {
    }
    var HTMLDomInteractionElement: {
        prototype: HTMLDomInteractionElement;
        new (): HTMLDomInteractionElement;
    };
    interface HTMLDomVisibleElement extends Components.DomVisible, HTMLRindoElement {
    }
    var HTMLDomVisibleElement: {
        prototype: HTMLDomVisibleElement;
        new (): HTMLDomVisibleElement;
    };
    interface HTMLDsdListenCmpElement extends Components.DsdListenCmp, HTMLRindoElement {
    }
    var HTMLDsdListenCmpElement: {
        prototype: HTMLDsdListenCmpElement;
        new (): HTMLDsdListenCmpElement;
    };
    interface HTMLElementCmpElement extends Components.ElementCmp, HTMLRindoElement {
    }
    var HTMLElementCmpElement: {
        prototype: HTMLElementCmpElement;
        new (): HTMLElementCmpElement;
    };
    interface HTMLEmptyCmpElement extends Components.EmptyCmp, HTMLRindoElement {
    }
    var HTMLEmptyCmpElement: {
        prototype: HTMLEmptyCmpElement;
        new (): HTMLEmptyCmpElement;
    };
    interface HTMLEmptyCmpShadowElement extends Components.EmptyCmpShadow, HTMLRindoElement {
    }
    var HTMLEmptyCmpShadowElement: {
        prototype: HTMLEmptyCmpShadowElement;
        new (): HTMLEmptyCmpShadowElement;
    };
    interface HTMLEnvDataElement extends Components.EnvData, HTMLRindoElement {
    }
    ...
    interface HTMLEventCmpElement extends Components.EventCmp, HTMLRindoElement {
    ...
    interface HTMLHydratedSiblingAccessorsElement extends Components.HydratedSiblingAccessors, HTMLRindoElement {
    }
     ...
     * Component that helps display a list of cars
     */
    interface HTMLScopedCarListElement extends Components.ScopedCarList, HTMLRindoElement {
    ...
    interface HTMLShadowChildElement extends Components.ShadowChild, HTMLRindoElement {
    }
    var HTMLShadowChildElement: {
        prototype: HTMLShadowChildElement;
        new (): HTMLShadowChildElement;
    };
    interface HTMLShadowWrapperElement extends Components.ShadowWrapper, HTMLRindoElement {
    }
    var HTMLShadowWrapperElement: {
        prototype: HTMLShadowWrapperElement;
        new (): HTMLShadowWrapperElement;
    };
    interface HTMLSlotCmpElement extends Components.SlotCmp, HTMLRindoElement {
    }
    var HTMLSlotCmpElement: {
        prototype: HTMLSlotCmpElement;
        new (): HTMLSlotCmpElement;
    };
    interface HTMLSlotCmpContainerElement extends Components.SlotCmpContainer, HTMLRindoElement {
    }
    var HTMLSlotCmpContainerElement: {
        prototype: HTMLSlotCmpContainerElement;
        new (): HTMLSlotCmpContainerElement;
    };
    interface HTMLSlotParentCmpElement extends Components.SlotParentCmp, HTMLRindoElement {
    }
    var HTMLSlotParentCmpElement: {
        prototype: HTMLSlotParentCmpElement;
        new (): HTMLSlotParentCmpElement;
    };
    interface HTMLStateCmpElement extends Components.StateCmp, HTMLRindoElement {
    }

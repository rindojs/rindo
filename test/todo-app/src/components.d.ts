...
declare global {
    ...
    interface HTMLTodoInputElement extends Components.TodoInput, HTMLRindoElement {
    ...
    interface HTMLTodoItemElement extends Components.TodoItem, HTMLRindoElement {

 ...
 * @param opts build options containing the metadata needed to publish a new version of Rindo
 */
 ...
 *
 * Due to a bug in Inquirer, the tag to publish Rindo under needs to be specified under two different fields when

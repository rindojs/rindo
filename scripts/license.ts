...
/**
 * Dependencies that will be included in the Rindo output
 */
const entryDeps = [
...
/**
 * Generate LICENSE.md for Rindo
 * @param rootDir the root directory of the Rindo repo
 */
...
/**
 * Representation of a dependency that is bundled with Rindo which has a license to be written to disk
 */
 ...
 * alter Rindo's generated LICENSE.md file between releases.

    ...
    plugins: [
      {
        resolveId(id) {
          if (id === '@build-conditionals') {
            return {
              id: '@rindo/core/build-conditionals',
              external: true
            };
          }
          if (id === '@platform') {
            return {
              id: '@rindo/core/platform',
              external: true
            };
          }
          if (id === '@utils') {
    ...
    plugins: [
      {
        resolveId(id) {
          if (id === '@build-conditionals') {
            return {id: '@rindo/core/build-conditionals', external: true}
          }
          if (id === '@platform') {
...
async function createDts() {
  ...
  const declarationsFilePath = path.join(DIST_CLIENT_DIR, 'declarations', 'rindo.core.d.ts');

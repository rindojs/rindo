...
/**
 * Creates a rollup plugin to embed an optimized version of the TypeScript compiler into the Rindo compiler.
...
/**
 * Bundles the TypeScript compiler in the Rindo output. This function also performs several optimizations and

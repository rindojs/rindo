...
export async function sysNode(opts: BuildOptions) {
  ...
  const sysNodeBundle: RollupOptions = {
    ...
    plugins: [
      ...
      prettyMinifyPlugin(opts, getBanner(opts, `Rindo Node System`, true)),
    ],
    treeshake: {
  ...
  const sysNodeWorkerBundle: RollupOptions = {
    ...
    plugins: [
      ...
      aliasPlugin(opts),
      prettyMinifyPlugin(opts, getBanner(opts, `Rindo Node System Worker`, true)),
    ],
  };

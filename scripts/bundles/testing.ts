...
export async function testing(opts: BuildOptions) {
  ...
  const testingBundle: RollupOptions = {
    ...
    external,
    plugins: [
      lazyRequirePlugin(opts, ['@app-data'], '@rindo/core/internal/app-data'),
      lazyRequirePlugin(opts, ['@platform', '@rindo/core/internal/testing'], '@rindo/core/internal/testing'),
      lazyRequirePlugin(opts, ['@rindo/core/dev-server'], '../dev-server/index.js'),
      lazyRequirePlugin(opts, ['@rindo/core/mock-doc'], '../mock-doc/index.cjs'),
      {
        name: 'testingImportResolverPlugin',
        resolveId(importee) {
          if (importee === '@rindo/core/compiler') {
            return {
              id: '../compiler/rindo.js',
              external: true,
            };
          }
          if (importee === 'chalk') {
      ...
      prettyMinifyPlugin(opts, getBanner(opts, `Rindo Testing`, true)),

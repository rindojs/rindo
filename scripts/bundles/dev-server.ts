...
export async function devServer(opts: BuildOptions) {
  ...
  const devServerIndexBundle: RollupOptions = {
    ...
    output: {
      ...
      esModule: false,
      preferConst: true,
      banner: getBanner(opts, `Rindo Dev Server`, true),
    },
    external,
    plugins,
    treeshake: {
  ...
  const devServerProcessBundle: RollupOptions = {
    ...
    output: {
      ...
      esModule: false,
      preferConst: true,
      banner: getBanner(opts, `Rindo Dev Server Process`, true),
    },
    external,
    plugins,
    treeshake: {
    ...
    plugins: [
      {
        ...
        resolveId(id) {
          if (id === '@rindo/core/dev-server/client') {
  ...
  const devServerClientBundle: RollupOptions = {
    ...
    output: {
      ...
      banner: getBanner(opts, `Rindo Dev Server Client`, true),
    },

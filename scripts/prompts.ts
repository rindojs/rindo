...
export type NormalizedPrepareResponses = {
  ...
  confirm: boolean;
  /**
   * The semver string to publish use Rindo under
   */
  versionToUse: string;
};
 ...
 *
 * Due to a bug in Inquirer, the version to publish Rindo under needs to be specified under two different fields when

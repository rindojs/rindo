...
export async function getInternalClientBundles(opts: BuildOptions): Promise<ESBuildOptions[]> {
  ...
  // write @rindo/core/internal/client/package.json
  writePkgJson(opts, outputInternalClientDir, {
    name: '@rindo/core/internal/client',
    description:
      'Rindo internal client platform to be imported by the Rindo Compiler and internal runtime. Breaking changes can and will happen at any time.',
    exports: './index.js',
    main: './index.js',
    type: 'module',
    sideEffects: false,
  ...
  const internalClientBundle: ESBuildOptions = {
    ...
    banner: {
      js: getBanner(opts, 'Rindo Client Platform'),
    },
    plugins: [
  ...
  const patchBrowserExternal = [...externalNodeModules, '@rindo/core', '@rindo/core/mock-doc'];
  ...
  const internalClientPatchBrowserBundle: ESBuildOptions = {
    ...
    banner: {
      js: getBanner(opts, 'Rindo Client Patch Browser'),
    },
    plugins: [
      replace(createReplaceData(opts)),
      externalAlias('@platform', '@rindo/core'),
      externalAlias('@app-data', '@rindo/core/internal/app-data'),
    ],
  };

...
export async function getInternalTestingBundle(opts: BuildOptions): Promise<ESBuildOptions> {
  ...
  // write @rindo/core/internal/testing/package.json
  writePkgJson(opts, outputTestingPlatformDir, {
    name: '@rindo/core/internal/testing',
    description:
      'Rindo internal testing platform to be imported by the Rindo Compiler. Breaking changes can and will happen at any time.',
    main: 'index.js',
  });
  ...
  const external = [...getEsbuildExternalModules(opts, opts.output.internalDir), '@rindo/core/mock-doc'];

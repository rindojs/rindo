...
export function getEsbuildAliases(): Record<string, string> {
  return {
    ...
    '@rindo/core/testing': './testing/index.js',
    ...
    // of the Rindo distributable but also have our separate bundles
 ...
 * @param opts Rindo build options
 ...
 * @see https://rindojs.web.app/docs/support-policy#browser-support
